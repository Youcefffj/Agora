...
<html>
<head>
    <title>Agora Francia - Neufs</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="flash">
            <h2>Produits neufs</h2>
        </div>

        <main>
            <div class="container">
                <div class="card">
                    <img src="images/produit_neuf1.jpg" class="image1">
                    <p>Produit neuf 1</p>
                </div>

                <div class="card">
                    <img src="images/produit_neuf2.jpg" class="image1">
                    <p>Produit neuf 2</p>
                </div>

                <div class="card">
                    <img src="images/produit_neuf3.jpg" class="image1">
                    <p>Produit neuf 3</p>
                </div>
            </div>
        </main>
