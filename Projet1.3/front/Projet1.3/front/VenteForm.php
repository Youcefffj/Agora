...
<html>
    ...
    function SellForm()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $prepare = Connection::$db->prepare("INSERT INTO item(nom, photos, descriptions, video, prix, id_categorie, vendeur, enchere, prix_enchere, date_publi) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, DATE_ADD(NOW(), INTERVAL 2 DAY))");
