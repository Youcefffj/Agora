...
INSERT INTO item (id_item, nom, photos, descriptions, video, prix, id_categorie)
VALUES
    (1, 'Table en bois', 'table1.jpg', 'Belle table en bois massif', NULL, 200, 1),
    (2, 'Collier en argent', 'collier2.jpg', 'Collier avec pendentif en argent', NULL, 150, 4),
    (3, 'Cahier A4', 'cahier3.jpg', 'Cahier de format A4', NULL, 5, 3),
    (4, 'T-shirt noir', 'tshirt4.jpg', 'T-shirt noir de taille M', NULL, 20, 5),
    (5, 'Ordinateur portable', 'laptop5.jpg', 'Ordinateur portable avec processeur i7', NULL, 1000, 5);
