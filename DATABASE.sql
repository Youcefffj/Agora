...
INSERT INTO item (id_item, nom, photos, descriptions, video, prix, id_categorie, vendeur, enchere)
VALUES
    (1, 'Table en bois', 'table1.jpg', 'Belle table en bois massif', NULL, 200, 1, 5, "oui"),
    (2, 'Collier en argent', 'collier2.jpg', 'Collier avec pendentif en argent', NULL, 150, 4, 1, "non"),
    (3, 'Cahier A4', 'cahier3.jpg', 'Cahier de format A4', NULL, 5, 3, 4,"non"),
    (4, 'T-shirt noir', 'tshirt4.jpg', 'T-shirt noir de taille M', NULL, 20, 5, 3, "oui"),
    (5, 'Ordinateur portable', 'laptop5.jpg', 'Ordinateur portable avec processeur i7', NULL, 1000, 5, 7, "non");

INSERT INTO moy_paiement (id_moy_paiement, num_carte, type_carte, nom_carte, date_exp, securite)
VALUES
    (1, '1234567890123456', 'Visa', 'John Doe', '2025-12-31', '123'),
    (2, '9876543210987654', 'MasterCard', 'Jane Smith', '2024-06-30', '789'),
    (3, '5555444433332222', 'Visa', 'Mark Johnson', '2023-09-30', '456'),
    (4, '1111222233334444', 'American Express', 'Sarah Wilson', '2026-03-31', '789'),
    (5, '6666777788889999', 'Visa', 'Michael Brown', '2024-11-30', '234');
